...
var Wkt = (_temp2 = _class = function (_MapComponent) {
    ...
    Wkt.prototype.componentDidMount = function componentDidMount() {
        this.renderWkt();
    };

    Wkt.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
        if (this.checkPropsChange(['data', 'style'], prevProps)) {
            this.renderWkt();
        }
    };

    Wkt.prototype.renderWkt = function renderWkt() {
